<?php
class WP_wppt_test_widget extends WP_Widget {
		
	public function __construct() {
		$widget_ops = array( 
			'classname' => 'wp_wppt_ptbl_widget',
			'description' => 'Wppt-Test Table Section Widget',
		);
		parent::__construct( 'wppt_test_widget', 'Wppt-Test Table Section Widget', $widget_ops );
	}
